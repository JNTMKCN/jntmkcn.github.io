...
(function(window, document) {
    ...
    class StandardPatch {
        ...
        validatePatch(file) {
            ...
            if (status === "on") {
                ...
                return '"' + this.name + '" 既不是打开的也不是关闭的! 你确定使用了正确的文件吗?';
            }
        }
    ...
    class PatchContainer {
        ...
        createUI() {
            ...
            label.innerHTML = "<strong>选择一个文件</strong> 或将其拖入";
            ...
            container.appendChild(createElementClass('h5', null, '点击名称预览补丁选项'));
            ...
            reader.onload = function(e) {
                ...
                for (var i = 0; i < self.patchers.length; i++) {
                    ...
                    if (patcher.validatePatches()) {
                        ...
                        self.matchSuccessText[i].textContent = ' ' + valid + ' 个补丁中有 ' + valid + '个匹配 (100%) ';
                    }
                }
                ...
                if (!found) {
                    ...
                    for (let i = 0; i < self.patchers.length; i++) {
                        ...
                        self.forceLoadTexts[i].textContent = ' ' + patcher.totalPatches + ' 个补丁中有  ' + valid + '个匹配 (' + percent + '%) ';
                    ...
                    self.errorDiv.innerHTML = "没有100%匹配的补丁.";
                }
            };
    ...
    class Patcher {
        ...
        loadBuffer(buffer) {
            ...
            this.saveButton.textContent = '保存修补后的文件';
        ...
        saveDll() {
            ...
            var blob = new Blob([this.dllFile], {
